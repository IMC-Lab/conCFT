...
if run == 1
 addpath('P:\MATLAB\PsychToolbox\3.0.16.8');
 cd 'P:\MATLAB\PsychToolbox\3.0.16.8'
 SetupPsychtoolbox;
 cd 'M:\DeBrigard\conCFT.01\Scripts'
end
...
stimulusFileName = ['../behavData/session1', sID, '/memlist_final_', sID, '.csv']; % stim list
...
try
    ...
    plausibility = imread('Ratings/plausibilityScreen.jpg');
    control = imread('Ratings/controlScreen.jpg');
    difficulty = imread('Ratings/difficultyScreen.jpg');
            ...
            for RatingNum = 1:3
               ...
               % define rating scale based on RatingOrder
                ...
                % if >1 keys were presed simultaneously, reduce to first key press. 
                 ...
                 if ratingResp ~= ' '
                        ratingScreen = imread(['Ratings/', response_image, ratingResp, '.jpg']);
