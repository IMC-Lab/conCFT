...
#threshold = valence_mean + valence_sd*(qnorm(0.95))
...
memlist$mutability <- 8 - mean(memlist$MK, memlist$KO)
memlist <- memlist[order(memlist$Valence, memlist$mutability),]
memlist <- memlist[1:67,]
